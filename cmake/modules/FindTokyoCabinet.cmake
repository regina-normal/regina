...
#  TOKYOCABINET_INCLUDEDIR - the Tokyo Cabinet include directory
...
IF (NOT TOKYOCABINET_FOUND)
  if (TOKYOCABINET_INCLUDEDIR AND TOKYOCABINET_LIBRARIES)
    # Already in cache, be silent
    set(TOKYOCABINET_FIND_QUIETLY TRUE)
  endif (TOKYOCABINET_INCLUDEDIR AND TOKYOCABINET_LIBRARIES)

  find_path(TOKYOCABINET_INCLUDEDIR NAMES ${TOKYOCABINET_TESTHEADER})
  find_library(TOKYOCABINET_LIBRARIES NAMES ${TOKYOCABINET_LIBNAME} lib${TOKYOCABINET_LIBNAME})

  include(FindPackageHandleStandardArgs)
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(TokyoCabinet DEFAULT_MSG TOKYOCABINET_INCLUDEDIR TOKYOCABINET_LIBRARIES)

  mark_as_advanced(TOKYOCABINET_INCLUDEDIR TOKYOCABINET_LIBRARIES)
