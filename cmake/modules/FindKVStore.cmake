...
IF (${REGINA_KVSTORE} STREQUAL tokyocabinet OR
...
IF (${REGINA_KVSTORE} STREQUAL qdbm OR
    (${REGINA_KVSTORE} STREQUAL any AND NOT KVSTORE_FOUND))
  SET(REGINA_KVSTORE_OPTION_FOUND TRUE)
...
IF (${REGINA_KVSTORE} STREQUAL lmdb OR
    (${REGINA_KVSTORE} STREQUAL any AND NOT KVSTORE_FOUND))
  SET(REGINA_KVSTORE_OPTION_FOUND TRUE)
...
IF (NOT REGINA_KVSTORE_OPTION_FOUND)
  MESSAGE(FATAL_ERROR "REGINA_KVSTORE must be one of: ${KVSTORE_OPTIONS}")
ENDIF (NOT REGINA_KVSTORE_OPTION_FOUND)
