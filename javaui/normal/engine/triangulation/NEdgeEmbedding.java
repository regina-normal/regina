...
public class NEdgeEmbedding {
    private NTetrahedron tetrahedron;
    private int edge;

    public NEdgeEmbedding(NTetrahedron tetrahedron, int edge) {
        this.tetrahedron = tetrahedron;
        this.edge = edge;
    }
    public NEdgeEmbedding(NEdgeEmbedding cloneMe) {
        this.tetrahedron = cloneMe.tetrahedron;
        this.edge = cloneMe.edge;
    }
