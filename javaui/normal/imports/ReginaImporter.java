...
/**
 * An interface through which the user can import another Regina packet tree.
 * See <tt>Importer</tt> for further details.
 *
 * @see normal.imports.Importer
 */
public class ReginaImporter extends Importer {
    /**
     * Creates a new importer.
     *
     * @param shell the shell representing the entire program.
     */
    public ReginaImporter(Shell shell) {
        super(shell, TopologyPane.filenameFilter);
    }
     
    public String getDialogTitle() {
        return "Import Regina Data File";
    }
