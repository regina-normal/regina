...
QVariant Dim4GluingsModel::headerData(int section, Qt::Orientation orientation,
    ...
    switch (section) {
        case 0: return i18n("Pentachoron");
        case 1: return i18n("Facet 0123");
        case 2: return i18n("Facet 0124");
        case 3: return i18n("Facet 0134");
        case 4: return i18n("Facet 0234");
        case 5: return i18n("Facet 1234");
    }
    return QVariant();
}
...
Dim4TriGluingsUI::Dim4TriGluingsUI(regina::Dim4Triangulation* packet,
    ...
    if (readWrite)
        facetTable->setEditTriggers(QAbstractItemView::AllEditTriggers);
    else
        facetTable->setEditTriggers(QAbstractItemView::NoEditTriggers);

    facetTable->setWhatsThis(i18n("<qt>A table specifying which pentachoron "
    ...
    actAddPent = triActions->addAction("tri_add_pent");
    actAddPent->setText(i18n("&Add Pent"));
    actAddPent->setIcon(KIcon("edit-table-insert-row-below"));
    ...
    actRemovePent = triActions->addAction("tri_remove_pent");
    actRemovePent->setText(i18n("&Remove Pent"));
    actRemovePent->setIcon(KIcon("edit-table-delete-row"));
...
const QLinkedList<KAction*>& Dim4TriGluingsUI::getPacketTypeActions() {
...
void Dim4TriGluingsUI::removeSelectedPents() {
    ...
    QString message;
    if (first == last)
        message = i18n("1 pentachoron (number %1) will be removed.  "
            "Are you sure?").arg(first);
    else
        message = i18n("%1 pentachora (numbers %2 to %3) will be removed.  "
