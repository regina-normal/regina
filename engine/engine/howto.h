 ...
 *        <tt>ClassName_i::InterfaceClass::_nil()</tt> (or
 *        <tt>Regina::ClassLoc::ClassName::_nil()</tt>) should be
 *        returned.</li>
 *      </ul></li>
 *    <li><i>Java User Interface:</i>
 *      <ul>
 ...
 *            derive from the virtual base class
 *            <tt>POA_Regina::ClassLoc::ClassName</tt> (autogenerated
 *            from the IDL sources).</li>
 *            <li>Typedefs <tt>ServantClass</tt>, <tt>EngineClass</tt>
 *            and <tt>InterfaceClass</tt> should be declared to
 *            represent classes <tt>ClassName_i</tt>, <tt>ClassName</tt>
 *            and <tt>Regina::ClassLoc::ClassName</tt> respectively.
 *            The macro STANDARD_ENGINE_TYPEDEFS() will do this for you.</li>
 ...
 *            returns <tt>ClassName_i::InterfaceClass::_nil()</tt>
 *            if <tt>null</tt> is passed.
