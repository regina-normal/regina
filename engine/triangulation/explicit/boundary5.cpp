...
extern template BoundaryComponent<4>::~BoundaryComponent();

template BoundaryComponent<5>::~BoundaryComponent();

template Triangulation<4>* BoundaryComponent<5>::buildRealBoundary() const;
