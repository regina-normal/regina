...
template std::string IsoSigBinary::asString<9>(const ByteSequence&);

namespace detail {

template std::string
    TriangulationBase<9>::isoSig<IsoSigPrintable, IsoSigClassic<9>>() const;
template std::pair<std::string, Isomorphism<9>>
    TriangulationBase<9>::isoSigDetail<IsoSigPrintable, IsoSigClassic<9>>()
    const;

template std::string
    TriangulationBase<9>::neoSig<IsoSigPrintable,
    IsoSigRidgeDegrees<9>>(bool) const;
template std::pair<std::string, Isomorphism<9>>
    TriangulationBase<9>::neoSigDetail<IsoSigPrintable,
    IsoSigRidgeDegrees<9>>(bool) const;

template Triangulation<9> TriangulationBase<9>::fromSig(const std::string&);
...
template bool TriangulationBase<9>::internalPachner(Face<9, 0>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 1>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 2>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 3>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 4>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 5>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 6>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 7>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Face<9, 8>*, bool, bool);
template bool TriangulationBase<9>::internalPachner(Simplex<9>*, bool, bool);

template bool TriangulationBase<9>::internal20(Face<9, 0>*, bool, bool);
template bool TriangulationBase<9>::internal20(Face<9, 1>*, bool, bool);
template bool TriangulationBase<9>::internal20(Face<9, 2>*, bool, bool);
...
template Triangulation<9> TriangulationBase<9>::doubleCover() const;
template Triangulation<9> TriangulationBase<9>::doubleOverBoundary() const;
template bool TriangulationBase<9>::makeIdeal();
