...
class SimplexInfo {
    ...
    public:
        ...
        /**
         * Checks if the given permutation of vertices for a given simplex if each
         * vertex label in the comparison is ranked equal or higher then
         * the previous vertex label in the permutation. 
         *
         * @param perm The permutation tested
         * @return \c true if and only if the above condition is satisfied
         */
        bool permIsOrdered(int perm);         

        /**
         * Prints simplex annotations in a readable manner like:
         * subdim=0
         * arr[0] arr[1] arr[2] ...
        */
