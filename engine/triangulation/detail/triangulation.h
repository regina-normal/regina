...
class TriangulationBase :
    ...
    public:
         ...
         * vertex, and to include in the graph name; see dot() for details.
         ...
         * FacetPairing<dim>::dotHeader() or
         * FacetPairing<dim>::writeDotHeader(), followed by one or more
         * subgraphs and then a closing curly brace will suffice.  The
         * subgraph name will begin with the string \c tri_.
         *
         ...
         *
         * The strings returned by `dot()` versus `pairing().dot()`
         * are almost identical: the only differences are the subgraph names
         * (if relevant), and the fact that Triangulation::dot() will use
         * colours to indicate locked top-dimensional simplices and/or facets.
         *
...
template <int dim>
inline std::string TriangulationBase<dim>::dot(
