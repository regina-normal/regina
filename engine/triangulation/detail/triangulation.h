...
class TriangulationBase :
    ...
    public:
         ...
         *   offer a \a SigType typedef, and static functions emptySig() and
         ...
         * algorithm and encoding are supported.  Moreover, the isomorphism
         * argument is not present; instead there are two routines: isoSig(),
         * which returns a string only, and isoSigDetail(), which returns a
         * pair (\a signature, \a relabelling).
         *
