...
/*! \file triangulation/generic/example.h
 *  \brief Offers some example triangulations as starting points for
 *  testing code or getting used to Regina.
 */

#ifndef __EXAMPLE_H_GENERIC
#ifndef __DOXYGEN
#define __EXAMPLE_H_GENERIC
#endif
