 ...
 *	complements is based on the conjecture appearing in
 *
 ...
 *
 *  That article constructs a triangulation for a 2-bridge knot or link
 *	complement, and conjectures that it is the canonical one.
 *	The conjecture was eventually proven by Sakuma and others,
 *	but the proof is long and difficult.
 *	In the meantime, SnapPea had verified the conjecture
 ...
 *	of the (allegedly) canonical triangulation [in fact the best
 *	illustration didn't appear in the article, so read on...].
