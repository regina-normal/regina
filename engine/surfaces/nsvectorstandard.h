...
#ifndef __REGINA_NSVECTORSTANDARD_H
#ifndef __DOXYGEN
#define __REGINA_NSVECTORSTANDARD_H
#endif
...
struct NormalInfo<NS_STANDARD> {
    ...
    static constexpr const char* name = "Standard normal (tri-quad)";
    static constexpr bool almostNormal = false;
    static constexpr bool spun = false;
    static constexpr bool oriented = false;
    static constexpr size_t dimension(size_t n) { return 7 * n; }
};
#endif
 ...
 */
class NSVectorStandard : public NormalSurfaceVector {
...
template <typename T>
inline NSVectorStandard::NSVectorStandard(const Vector<T>& cloneMe) :
