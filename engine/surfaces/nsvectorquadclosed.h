...
#ifndef __REGINA_NSVECTORQUADCLOSED_H
#ifndef __DOXYGEN
#define __REGINA_NSVECTORQUADCLOSED_H
#endif
...
struct NormalInfo<NS_QUAD_CLOSED> {
    ...
    static constexpr const char* name = "Closed quad";
 ...
 */
class NSVectorQuadClosed : public NSVectorQuad {
