 ...
 *   index of the permutation in the array Perm<6>::Sn.  The routines
...
class Perm<6> {
    public:
         ...
         * five elements.
         *
         * \deprecated Just use Perm<5>::nPerms instead.
         */
        [[deprecated]] static constexpr Index nPerms_1 = 120;
    ...
    public:
         ...
         * Perm<6> is to make it easier to write generic code that works with
         * Perm<n> for any \a n.
         *
         ...
         * Perm<6>, precompute() does not affect inverse computations;
         ...
         * An example of a string representation is `304521`.
         *
         ...
         * (which for Perm<6> will always fit within a \c size_t).  This
    ...
    private:
         ...
         * permutations in S6.
         *
         * Specifically, the permutation `S6[i]` has
         * first-generation code `code1Table[i]`.
         */
         ...
         *
         * Specifically, the inverse of permutation `S6[i]` is
         * the permutation `S6[ invS6[i] ]`.
         */
         ...
         * `S6[swapTable[x][y]]`.  Here \a x and \a y may be equal.
         */
    ...
    private:
        ...
        /**
         * Converts between an index into Perm<6>::Sn and an index into
         * Perm<6>::orderedSn.  This conversion works in either direction.
         */
...
template <CppInteger Int>
requires (sizeof(Int) >= sizeof(Perm<6>::Code2))
...
inline Perm<6> Perm<6>::cachedInverse() const {
    return Perm<6>(invS6[code2_]);
}
...
inline constexpr size_t Perm<6>::hash() const {
    return code2_;
}
