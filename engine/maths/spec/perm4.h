...
class Perm<4> {
    ...
    public:
         ...
         */
        static constexpr PermSn<4, PermOrder::Sign> S4 {};
    ...
    public:
         ...
         * The only point of having precompute() in Perm<4> is to make it
         ...
         */
        constexpr Perm<4>& operator = (const Perm<4>& cloneMe) = default;
         ...
         *
         * This specialised Perm<4> class does not use precomputation for its
         * optimisations.  The only point of having cachedComp() in Perm<4>
         * is to make it easier to write generic code that works with Perm<n>
         * for any \a n.
         *
         * - If you know you are only working with Perm<4>, you should just
         *   use the composition operator instead.
         *
         * - If you are writing generic code, you _must_ remember to call
         *   precompute() at least once in the lifetime of this program
         *   before using cachedComp().  (For Perm<4>, which does not use
         ...
         * lifetime of this program before calling cachedComp().  For Perm<4>,
         ...
         * Perm<4> is to make it easier to write generic code that works with
         * Perm<n> for any \a n.
         *
         * - If you know you are only working with Perm<4>, you should just
         ...
         * - If you are writing generic code, you _must_ remember to call
         *   precompute() at least once in the lifetime of this program
         *   before using cachedConjugate().  (For Perm<4>, which does not use
         *   precomputation for its optimisations, precompute() does nothing.)
         *
         * \pre You _must_ have called precompute() at least once in the
         ...
         *
         * This specialised Perm<4> class does not use precomputation for its
         * optimisations.  The only point of having cachedInverse() in Perm<4>
         * is to make it easier to write generic code that works with Perm<n>
         * for any \a n.
         *
         * - If you know you are only working with Perm<4>, you should just
         ...
         * - If you are writing generic code, you _must_ remember to call
         *   precompute() at least once in the lifetime of this program
         *   before using cachedInverse().  (For Perm<4>, which does not use
         *   precomputation for its optimisations, precompute() does nothing.)
         *
         * \pre You _must_ have called precompute() at least once in the
         * lifetime of this program before calling cachedInverse().  For
         * Perm<4>, precompute() does nothing; however, for other Perm<n>
         * classes a failure to do this will almost certainly crash your
         * program.
         *
         * \return the inverse of this permutation.
         ...
         *
         * This specialised Perm<4> class does not use precomputation for its
         * optimisations.  The only point of having cachedPow() in Perm<4>
         * is to make it easier to write generic code that works with Perm<n>
         * for any \a n.
         *
         * - If you know you are only working with Perm<4>, you should just
         ...
         * - If you are writing generic code, you _must_ remember to call
         *   precompute() at least once in the lifetime of this program
         *   before using cachedPow().  (For Perm<4>, which does not use
         *   precomputation for its optimisations, precompute() does nothing.)
         *
         * \pre You _must_ have called precompute() at least once in the
         ...
         *
         * This specialised Perm<4> class does not use precomputation for its
         * optimisations.  The only point of having cachedOrder() in Perm<4>
         * is to make it easier to write generic code that works with Perm<n>
         * for any \a n.
         *
         * - If you know you are only working with Perm<4>, you should just
         ...
         * - If you are writing generic code, you _must_ remember to call
         *   precompute() at least once in the lifetime of this program
         *   before using cachedOrder().  (For Perm<4>, which does not use
         *   precomputation for its optimisations, precompute() does nothing.)
         *
         * \pre You _must_ have called precompute() at least once in the
         ...
         * This maps \a k to \a k + \a i (mod 4) for all \a k.
         *
    ...
    friend class PermSn<4, PermOrder::Sign>;
    friend class PermSn<4, PermOrder::Lex>;
};
...
inline constexpr void Perm<4>::setPermCode1(Code1 code) {
    code_ = static_cast<Code2>(S4Index(
        code & 0x03,
        (code >> 2) & 0x03,
        (code >> 4) & 0x03,
...
inline constexpr void Perm<4>::setPermCode2(Code2 code) {
    code_ = code;
}
...
inline constexpr Perm<4> Perm<4>::conjugate(const Perm<4>& q) const {
...
inline constexpr Perm<4>& Perm<4>::operator ++() {
    if (++code_ == 24)
        code_ = 0;
    return *this;
}
...
inline Perm<4> Perm<4>::tightDecoding(const std::string& enc) {
    try {
