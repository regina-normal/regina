 ...
 * sources.  It takes care of C++ name mangling as well as whatever
 * <tt>JNIEXPORT</tt> usually handles.
 *
 * It is used so the JNI sources do not need to depend on the
 * autogenerated JNI headers, since these headers seem to change their
 * declarations depending upon which flavour of <tt>javah</tt> is used.
 */
#define REGJNIEXPORT extern "C" JNIEXPORT
