...
// NPerm5::S5 ie, the i-th A5 element is NPerm5::S5[2*i].
const unsigned long long NBinaryA5::mult_table[60] = { 0x0LL, 
...
// NBinaryA5::names[i] is the cycle decomposition of NPerm5::S5[i] provided i 
// is even.  If i is odd, it is the notation for the corresponding element of 
// the binary A5 group.
const std::string NBinaryA5::names[120] = { "1", "-1", "(234)", "-(234)", 
