...
AbelianGroup AbelianGroup::tightDecoding(std::istream& input) {
    AbelianGroup ans(regina::tightDecoding<unsigned long>(input));
    ...
    while (true) {
        Integer fac = regina::tightDecoding<Integer>(input);
        if (fac == 0) {
