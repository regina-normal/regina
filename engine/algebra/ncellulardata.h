 ...
 *        Move all the test routines out of the NCellularData class and put 
 ...
 *        trusting it to the NCellularData stack.
 ...
 *
 *       ncellulardata.cpp - contains only the core routines to call for 
 ...
 *  - the NCellularData::NCellularData(NTriangulation / Dim4Triangulation)
...
public:
  ...
  * of these cells to that subspace. See NCellularData::unmarkedGroup, 
  * NCellularData::markedGroup, NCellularData::homGroup, 
    NCellularData::bilinearForm, 
  ...
  * See NCellularData::unmarkedGroup, NCellularData::markedGroup,
  *  NCellularData::homGroup, 
  ...
  *
  * Note: when computing the torsion linking form, NCellularData chooses an 
 ...
 /**
  *  NCellularData stores chain complexes internally in a stack. The Chain 
  * Complex Locator allows unique identification of a chain complex when 
  * passing requests to NCellularData::chainComplex Chain complexes are 
 ...
 /**
  *  NCellularData stores chain maps internally in a stack. The Chain Map
  *  Locator allows unique identification of a chain maps when passing 
  *  requests to NCellularData::chainMap
  */
  ...
  * NCellularData::unmarkedGroup, NCellularData::markedGroup, 
  * NCellularData::homGroup and NCellularData::bilinearForm for usage.
  */
 struct GroupLocator {
 ...
 /**
  * NCellularData::homGroupPresentation requires a 
...
private:
     ...
     * triangulation NCellularData is initialised by.
     */
...
public:
     ...
     *  (if possible) or provides as much detail as NCellularData can 
     *  ascertain, if not.  
     *
