...
class GroupPresentation : public Output<GroupPresentation> {
    ...
    private:
         ...
         *  algorithm.
         *
         *  Given a word \a target and \a reducer, apply the substitution
         *  specified by \a sub to `this`. See dehnAlgorithm() and struct
         *  WordSubstitutionData.  In particular \a sub needs to be a
