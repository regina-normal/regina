...
class GroupPresentation : public Output<GroupPresentation> {
    ...
    private:
        ...
        /**
         * Inverts the splay() operation and simplifies the resulting word.
         */
        static GroupExpression desplay(const SplayedWord& word);
         ...
         */
        static void applySubstitution(GroupExpression& target,
