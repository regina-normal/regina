...
class REGINA_API NTreeDecomposition :
    ...
    public:
        ...
        /**
         * Writes the graph corresponding to this tree decomposition in
         ...
         */
        std::string dot(const char* prefix = 0, bool subgraph = false) const;

        /**
         * Writes header information for a Graphviz DOT file that will
         * describe the graphs for one or more tree decompositions.  See
         ...
         * only a single tree decomposition, this routine is unnecessary; you
