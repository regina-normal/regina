...
// Inline functions for NGlobalDirs:

inline std::string NGlobalDirs::home() {
    return home_;
}

inline std::string NGlobalDirs::pythonModule() {
    return pythonModule_;
}

inline std::string NGlobalDirs::census() {
    return census_;
}

inline std::string NGlobalDirs::pythonLibs() {
    return home_ + "/pylib";
}

inline std::string NGlobalDirs::examples() {
    return home_ + "/examples";
}

inline std::string NGlobalDirs::engineDocs() {
    return home_ + "/engine-docs";
}

inline std::string NGlobalDirs::data() {
    return home_ + "/data";
}
