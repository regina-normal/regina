...
#ifndef __REGINA_XMLTRIREADER4_H
#ifndef __DOXYGEN
#define __REGINA_XMLTRIREADER4_H
#endif
 ...
 */
template <>
class XMLTriangulationReader<4> : public XMLTriangulationReaderBase<4> {
    public:
        /**
         ...
         * This should be 0 if we are reading the second-generation ile format.
...
inline XMLTriangulationReader<4>::XMLTriangulationReader(
        ...
        XMLTriangulationReaderBase<4>(resolver, parent, anon,
