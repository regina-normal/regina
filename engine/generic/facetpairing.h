 ...
 * this class is available under the names FacetPairing2 and FacetPairing3
...
class REGINA_API FacetPairing : public FacetPairingBase<dim> {
    ...
    friend class FacetPairingBase<dim>;
};
