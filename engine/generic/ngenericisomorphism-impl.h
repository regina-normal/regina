...
template <int dim>
void IsomorphismBase<dim>::writeTextShort(std::ostream& out) const {
    out << "Isomorphism between " << dim << "-manifold triangulations";
}

template <int dim>
void IsomorphismBase<dim>::writeTextLong(std::ostream& out) const {
...
template <int dim>
IsomorphismBase<dim>::IsomorphismBase(
        const IsomorphismBase<dim>& cloneMe) :
...
template <int dim>
typename IsomorphismBase<dim>::Isomorphism* IsomorphismBase<dim>::
...
template <int dim>
typename IsomorphismBase<dim>::Triangulation*
        IsomorphismBase<dim>::apply(
        const typename IsomorphismBase<dim>::Triangulation* original)
        const {
...
void IsomorphismBase<dim>::applyInPlace(
        typename IsomorphismBase<dim>::Triangulation* tri) const {
