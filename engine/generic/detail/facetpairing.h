...
/*! \file generic/detail/facetpairing.h
...
template <int dim>
inline void FacetPairingBase<dim>::match(const NFacetSpec<dim>& facet1, const NFacetSpec<dim>&
                facet2) {
...
template <int dim>
inline void FacetPairingBase<dim>::match(int tet1, int facet1,
...
template <int dim>
inline void FacetPairingBase<dim>::unMatch(const NFacetSpec<dim>& facet) {
...
template <int dim>
inline void FacetPairingBase<dim>::unMatch(int tet, int facet) {
