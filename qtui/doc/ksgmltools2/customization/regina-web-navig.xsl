...
<xsl:template name="header.navigation">
  ...
  <xsl:if test="$suppress.navigation = '0'">
		...
		<tr id="logo">
		  <td valign="top">
		    <a href="http://regina.sourceforge.net/"><img src="regina_logo.png" alt="Regina - Software for 3-manifold topology and normal surface theory" width="296" height="79" border="0" /></a>
		  </td>
