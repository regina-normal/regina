...
void LinkPolynomialUI::calculateJones() {
    ...
    std::thread(static_cast<const regina::Laurent<regina::Integer>& (Link::*)(
            Algorithm, int, ProgressTracker*) const>(&Link::jones),
        link, Algorithm::Default, ReginaPrefSet::threads(),
