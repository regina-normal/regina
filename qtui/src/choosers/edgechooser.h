...
#ifndef __EDGECHOOSER_H
#define __EDGECHOOSER_H
...
/**
 * A filter function, used to determine whether a given edge
 * should appear in the list.
 */
typedef bool (*EdgeFilterFunc)(regina::NEdge*);

/**
 * A widget through which a single edge of some triangulation
 ...
 */
class EdgeChooser : public QComboBox, public regina::NPacketListener {
    Q_OBJECT
    ...
    public:
         ...
         *
         * The given filter may be 0, in which case every edge
         * will be offered.
         */
        EdgeChooser(regina::NTriangulation* tri,
         ...
         */
        regina::NEdge* selected();

        /**
         * Changes the selection to the given edge.
         *
         * If the given edge is not one of the options in this
         ...
         */
        void select(regina::NEdge* option);
    ...
    private:
         ...
         */
        QString description(regina::NEdge* option);
...
class EdgeDialog : public QDialog {
    ...
    public:
        ...
        static regina::NEdge* choose(QWidget* parent,
            regina::NTriangulation* tri,
            EdgeFilterFunc filter,
            const QString& title,
            const QString& message,
...
inline bool EdgeChooser::refresh() {
    clear();
    options_.clear();
    fill();
    return (count() > 0);
...
inline void EdgeChooser::packetToBeChanged(regina::NPacket*) {
    clear();
    options_.clear();
}

inline void EdgeChooser::packetWasChanged(regina::NPacket*) {
    fill();
}

inline void EdgeChooser::packetToBeDestroyed(regina::NPacket*) {
    clear();
    options_.clear();
}
