...
const QString ReginaAbout::regLicense( tr( 
    ...
    "SYNTAX HIGHLIGHTING:\n\n"
    "Regina's graphical user interface includes the PythonSyntaxHighlighter\n"
    "class by Frankie Simon and others, which it uses for highlighting Python\n"
    "scripts.  This class is distributed under the X11 license; see the class\n"
    "header for the license details.\n\n"
    "ICONS:\n\n"
