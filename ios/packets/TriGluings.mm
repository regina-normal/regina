...
+ (NSString*)destStringFromFacet:(int)srcFacet dest:(regina::NTetrahedron*)destTet gluing:(const regina::NPerm<4>&)gluing
{
    if (! destTet)
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    if (editFacet >= 0) {
        ...
        if (dest.length == 0) {
            ...
            regina::NPerm<4> destGluing = regina::NPerm<4>(adj0, adj1, adj2, (6 - adj0 - adj1 - adj2)) *
