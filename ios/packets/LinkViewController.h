...
@property (class, readonly) UIColor* posColour;
@property (class, readonly) UIColor* negColour;
@property (class, readonly) UIColor* leftColour;
@property (class, readonly) UIColor* rightColour;
