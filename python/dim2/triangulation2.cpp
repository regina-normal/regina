...
void addTriangulation2(pybind11::module_& m, pybind11::module_& internal) {
    ...
    auto c = pybind11::class_<Triangulation<2>,
        ...
        .def("countFaces", (regina::python::countFacesFunc<2>)(
        ...
        .def("faces", (regina::python::facesFunc<2>)(&Triangulation<2>::faces),
        ...
        .def("face", (regina::python::faceFunc<2>)(&Triangulation<2>::face),
