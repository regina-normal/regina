...
void addTriangulation2(pybind11::module_& m, pybind11::module_& internal) {
    RDOC_SCOPE_BEGIN(Triangulation2)
    ...
    auto c = pybind11::class_<Triangulation<2>,
        ...
        .def_static("fromIsoSig", // deprecated
            overload_cast<const std::string&>(&Triangulation<2>::fromSig),
            rbase::fromIsoSig)
        .def_static("sigGeneration", &Triangulation<2>::sigGeneration,
            rbase::sigGeneration)
        .def_static("sigComponentSize",
            &Triangulation<2>::sigComponentSize, rbase::sigComponentSize)
        .def_static("isoSigComponentSize", // deprecated
            &Triangulation<2>::sigComponentSize, rbase::isoSigComponentSize)
    ...
    regina::python::add_global_swap<Triangulation<2>, rdoc>(m);
...
INSTANTIATE_ISOSIG_BINDING_FUNCTIONS(2)
