...
// Docstring regina::python::doc::ProgressTracker::__class
...
// Docstring regina::python::doc::ProgressTracker::__default
...
// Docstring regina::python::doc::ProgressTracker::newStage
static constexpr const char newStage[] =
...
// Docstring regina::python::doc::ProgressTracker::percent
...
// Docstring regina::python::doc::ProgressTracker::percentChanged
static constexpr const char percentChanged[] =
...
// Docstring regina::python::doc::ProgressTracker::setFinished
static constexpr const char setFinished[] =
...
// Docstring regina::python::doc::ProgressTracker::setPercent
static constexpr const char setPercent[] =
...
struct ProgressTrackerBase {

// Docstring regina::python::doc::ProgressTrackerBase::__class
static constexpr const char __class[] =
...
Multithreaded algorithms may use multiple writing threads. All read
and write operations on progress trackers are thread-safe.
...
// Docstring regina::python::doc::ProgressTrackerBase::cancel
static constexpr const char cancel[] =
...
// Docstring regina::python::doc::ProgressTrackerBase::description
...
// Docstring regina::python::doc::ProgressTrackerBase::descriptionChanged
static constexpr const char descriptionChanged[] =
...
// Docstring regina::python::doc::ProgressTrackerBase::isCancelled
static constexpr const char isCancelled[] =
...
// Docstring regina::python::doc::ProgressTrackerBase::isFinished
static constexpr const char isFinished[] =
...
// Docstring regina::python::doc::ProgressTrackerBase::setFinished
static constexpr const char setFinished[] =
R"doc(Used by the writing thread to indicate that it has finished all
...
struct ProgressTrackerObjective {

// Docstring regina::python::doc::ProgressTrackerObjective::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::ProgressTrackerObjective::__init
...
// Docstring regina::python::doc::ProgressTrackerObjective::newStage
static constexpr const char newStage[] =
R"doc(Used by the writing thread to indicate that it has moved on to a new
...
// Docstring regina::python::doc::ProgressTrackerObjective::objective
static constexpr const char objective[] =
...
// Docstring regina::python::doc::ProgressTrackerObjective::objectiveChanged
static constexpr const char objectiveChanged[] =
...
// Docstring regina::python::doc::ProgressTrackerObjective::setFinished
static constexpr const char setFinished[] =
R"doc(Used by the writing thread to indicate that it has finished all
...
// Docstring regina::python::doc::ProgressTrackerObjective::setObjective
static constexpr const char setObjective[] =
...
struct ProgressTrackerOpen {

// Docstring regina::python::doc::ProgressTrackerOpen::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::ProgressTrackerOpen::__default
static constexpr const char __default[] =
R"doc(Creates a new progress tracker. This sets a sensible state description
(which declares that the operation is initialising), and marks the
...
// Docstring regina::python::doc::ProgressTrackerOpen::incSteps
static constexpr const char incSteps[] =
...
// Docstring regina::python::doc::ProgressTrackerOpen::incSteps_2
static constexpr const char incSteps_2[] =
...
// Docstring regina::python::doc::ProgressTrackerOpen::newStage
static constexpr const char newStage[] =
R"doc(Used by the writing thread to indicate that it has moved on to a new
...
// Docstring regina::python::doc::ProgressTrackerOpen::setFinished
static constexpr const char setFinished[] =
R"doc(Used by the writing thread to indicate that it has finished all
...
// Docstring regina::python::doc::ProgressTrackerOpen::steps
...
// Docstring regina::python::doc::ProgressTrackerOpen::stepsChanged
static constexpr const char stepsChanged[] =
