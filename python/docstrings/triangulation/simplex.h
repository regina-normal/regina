...
// Docstring regina::python::doc::Simplex::__class
...
For Regina's standard dimensions, you can also describe this class
using the dimension-specific type aliases Triangle<2>, Tetrahedron<3>,
