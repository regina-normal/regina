...
// Docstring regina::python::doc::Triangulation::countBoundaryEdges
...
// Docstring regina::python::doc::Triangulation::eulerChar
...
// Docstring regina::python::doc::Triangulation::hasBoundaryEdges
...
// Docstring regina::python::doc::Triangulation::isMinimal
...
// Docstring regina::python::doc::Triangulation::newTriangle
...
// Docstring regina::python::doc::Triangulation::newTriangle_2
static constexpr const char newTriangle_2[] =
R"doc(A dimension-specific alias for newSimplex().

See newSimplex() for further information.)doc";

// Docstring regina::python::doc::Triangulation::newTriangles
...
// Docstring regina::python::doc::Triangulation::newTriangles_2
static constexpr const char newTriangles_2[] =
R"doc(A dimension-specific alias for newSimplices().

See newSimplices() for further information.)doc";

// Docstring regina::python::doc::Triangulation::removeAllTriangles
...
// Docstring regina::python::doc::Triangulation::removeTriangle
...
// Docstring regina::python::doc::Triangulation::removeTriangleAt
