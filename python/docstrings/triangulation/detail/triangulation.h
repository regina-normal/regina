...
(*subdim*-1)-faces of the triangulation.

This is analogous to boundaryMap(), but is designed to work with dual
faces instead of ordinary (primal) faces. In particular, this is used
in the implementation of homology(), which works with the dual
skeleton in order to effectively truncate ideal vertices.
...
// Docstring regina::python::doc::detail::TriangulationBase_::dualBoundaryMap_2
constexpr const char *dualBoundaryMap_2 =
R"doc(Returns the boundary map from dual *subdim*-faces to dual
...
// Docstring regina::python::doc::detail::TriangulationBase_::dualToPrimal_2
constexpr const char *dualToPrimal_2 =
R"doc(Returns a map from dual chains to primal chains that preserves
