...
// Docstring regina::python::doc::BlockedSFSPair_::__ne
static const char *__ne =
R"doc(Determines whether this and the given structure do not represent the
same type of blocked pair of Seifert fibred spaces.
...
Returns:
    ...
    represent the same type of blocked pair of Seifert fibred spaces.)doc";
