...
locked, this will not prevent the operation from occurring (since the
original triangulation will not be changed). The triangulation that is
returned will have no simplex and/or facet locks at all.
