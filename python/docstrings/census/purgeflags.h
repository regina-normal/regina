...
inline constexpr const char CensusPurge[] =
...
inline constexpr const char NonMinimal[] = R"doc(Indicates that non-minimal triangulations may be ignored.)doc";

// Docstring regina::python::doc::CensusPurge_::NonMinimalHyp
inline constexpr const char NonMinimalHyp[] =
...
inline constexpr const char NonMinimalPrime[] =
...
inline constexpr const char NonPrime[] =
R"doc(Indicates that any triangulation that is not prime (i.e., can be
...
inline constexpr const char P2Reducible[] =
