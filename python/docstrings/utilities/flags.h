...
static const char *Flags = R"doc(Creates an empty flag set, with no flags set at all.)doc";

// Docstring regina::python::doc::Flags_::Flags_2
static const char *Flags_2 =
