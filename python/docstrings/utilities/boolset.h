...
inline constexpr const char BoolSet[] =
...
inline constexpr const char __bnot[] =
...
inline constexpr const char __copy[] = R"doc(Creates a clone of the given set.)doc";

// Docstring regina::python::doc::BoolSet_::__default
inline constexpr const char __default[] = R"doc(Creates a new empty set.)doc";
...
inline constexpr const char byteCode[] =
...
inline constexpr const char fromByteCode[] =
...
inline constexpr const char fromStringCode[] =
...
inline constexpr const char full[] =
...
inline constexpr const char hasFalse[] =
...
inline constexpr const char hasTrue[] =
...
inline constexpr const char insertFalse[] = R"doc(Inserts ``False`` into this set if it is not already present.)doc";

// Docstring regina::python::doc::BoolSet_::insertTrue
inline constexpr const char insertTrue[] = R"doc(Inserts ``True`` into this set if it is not already present.)doc";

// Docstring regina::python::doc::BoolSet_::removeFalse
inline constexpr const char removeFalse[] = R"doc(Removes ``False`` from this set if it is present.)doc";

// Docstring regina::python::doc::BoolSet_::removeTrue
inline constexpr const char removeTrue[] = R"doc(Removes ``True`` from this set if it is present.)doc";

// Docstring regina::python::doc::BoolSet_::setByteCode
inline constexpr const char setByteCode[] =
...
inline constexpr const char setStringCode[] =
...
inline constexpr const char stringCode[] =
