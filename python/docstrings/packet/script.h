...
// Docstring regina::python::doc::Script_::Script
static const char *Script = R"doc(Initialises to a script with no text and no variables.)doc";

// Docstring regina::python::doc::Script_::Script_2
static const char *Script_2 =
