...
inline constexpr const char PacketInfo[] =
...
inline constexpr const char PacketType[] = R"doc(Represents the different types of packet that are available in Regina.)doc";
...
inline constexpr const char AngleStructures[] = R"doc(Represents an angle structure list, of class AngleStructures.)doc";

// Docstring regina::python::doc::PacketType_::Attachment
inline constexpr const char Attachment[] = R"doc(Represents an arbitrary file attachment, of class Attachment.)doc";

// Docstring regina::python::doc::PacketType_::Container
inline constexpr const char Container[] = R"doc(Represents a container packet, of class Container.)doc";
...
inline constexpr const char NormalHypersurfaces[] = R"doc(Represents a normal hypersurface list, of class NormalHypersurfaces.)doc";

// Docstring regina::python::doc::PacketType_::NormalSurfaces
inline constexpr const char NormalSurfaces[] = R"doc(Represents a normal surface list, of class NormalSurfaces.)doc";

// Docstring regina::python::doc::PacketType_::Script
inline constexpr const char Script[] = R"doc(Represents a script packet, of class Script.)doc";
...
inline constexpr const char Text[] = R"doc(Represents a text packet, of class Text.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation2
inline constexpr const char Triangulation2[] = R"doc(Represents a 2-dimensional triangulation, of class Triangulation<2>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation3
inline constexpr const char Triangulation3[] = R"doc(Represents a 3-dimensional triangulation, of class Triangulation<3>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation4
inline constexpr const char Triangulation4[] = R"doc(Represents a 4-dimensional triangulation, of class Triangulation<4>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation5
inline constexpr const char Triangulation5[] = R"doc(Represents a 5-dimensional triangulation, of class Triangulation<5>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation6
inline constexpr const char Triangulation6[] = R"doc(Represents a 6-dimensional triangulation, of class Triangulation<6>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation7
inline constexpr const char Triangulation7[] = R"doc(Represents a 7-dimensional triangulation, of class Triangulation<7>.)doc";

// Docstring regina::python::doc::PacketType_::Triangulation8
inline constexpr const char Triangulation8[] = R"doc(Represents a 8-dimensional triangulation, of class Triangulation<8>.)doc";
