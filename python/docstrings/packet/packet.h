...
// Docstring regina::python::doc::ChildIterator::__class
...
// Docstring regina::python::doc::ChildIterator::__eq
...
// Docstring regina::python::doc::ChildIterator::__next__
...
// Docstring regina::python::doc::Packet::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::Packet::__iter__
...
// Docstring regina::python::doc::Packet::addTag
static constexpr const char addTag[] =
...
// Docstring regina::python::doc::Packet::adornedLabel
static constexpr const char adornedLabel[] =
...
// Docstring regina::python::doc::Packet::append
...
// Docstring regina::python::doc::Packet::children
...
// Docstring regina::python::doc::Packet::children_2
static constexpr const char children_2[] =
R"doc(Returns a lightweight object for iterating through the immediate
children of this packet.
...
// Docstring regina::python::doc::Packet::cloneAsSibling
static constexpr const char cloneAsSibling[] =
...
// Docstring regina::python::doc::Packet::countChildren
static constexpr const char countChildren[] =
...
// Docstring regina::python::doc::Packet::countDescendants
static constexpr const char countDescendants[] =
...
// Docstring regina::python::doc::Packet::descendants
static constexpr const char descendants[] =
...
// Docstring regina::python::doc::Packet::descendants_2
static constexpr const char descendants_2[] =
R"doc(Returns a lightweight object for iterating through all strict
descendants of this packet in the packet tree.
...
// Docstring regina::python::doc::Packet::findPacketLabel
static constexpr const char findPacketLabel[] =
...
// Docstring regina::python::doc::Packet::findPacketLabel_2
static constexpr const char findPacketLabel_2[] =
R"doc(Finds the packet with the requested label in the tree or subtree for
which this packet is matriarch. Note that label comparisons are case
sensitive.
...
// Docstring regina::python::doc::Packet::firstChild
static constexpr const char firstChild[] =
...
// Docstring regina::python::doc::Packet::firstTreePacket
static constexpr const char firstTreePacket[] =
...
// Docstring regina::python::doc::Packet::firstTreePacket_2
static constexpr const char firstTreePacket_2[] =
R"doc(Finds the first packet of the requested type in a complete depth-first
iteration of the tree structure. Note that this packet **must** be the
matriarch of the entire tree.
...
// Docstring regina::python::doc::Packet::fullName
...
// Docstring regina::python::doc::Packet::hasParent
static constexpr const char hasParent[] =
...
// Docstring regina::python::doc::Packet::hasTag
static constexpr const char hasTag[] =
...
// Docstring regina::python::doc::Packet::hasTags
static constexpr const char hasTags[] =
...
// Docstring regina::python::doc::Packet::humanLabel
static constexpr const char humanLabel[] =
...
// Docstring regina::python::doc::Packet::insert
...
// Docstring regina::python::doc::Packet::insertChildAfter
static constexpr const char insertChildAfter[] =
...
// Docstring regina::python::doc::Packet::insertChildFirst
static constexpr const char insertChildFirst[] =
...
// Docstring regina::python::doc::Packet::insertChildLast
static constexpr const char insertChildLast[] =
...
// Docstring regina::python::doc::Packet::internalID
static constexpr const char internalID[] =
...
// Docstring regina::python::doc::Packet::isAncestorOf
static constexpr const char isAncestorOf[] =
...
// Docstring regina::python::doc::Packet::isListening
static constexpr const char isListening[] =
...
// Docstring regina::python::doc::Packet::label
...
// Docstring regina::python::doc::Packet::lastChild
...
// Docstring regina::python::doc::Packet::levelsDownTo
static constexpr const char levelsDownTo[] =
...
// Docstring regina::python::doc::Packet::levelsUpTo
static constexpr const char levelsUpTo[] =
...
// Docstring regina::python::doc::Packet::listen
static constexpr const char listen[] =
...
// Docstring regina::python::doc::Packet::makeOrphan
static constexpr const char makeOrphan[] =
...
// Docstring regina::python::doc::Packet::moveDown
static constexpr const char moveDown[] =
...
// Docstring regina::python::doc::Packet::moveToFirst
static constexpr const char moveToFirst[] =
R"doc(Moves this packet to be the first in its sibling list.

This routine takes small constant time.)doc";

// Docstring regina::python::doc::Packet::moveToLast
static constexpr const char moveToLast[] =
R"doc(Moves this packet to be the last in its sibling list.

This routine takes small constant time.)doc";

// Docstring regina::python::doc::Packet::moveUp
static constexpr const char moveUp[] =
...
// Docstring regina::python::doc::Packet::nextSibling
static constexpr const char nextSibling[] =
...
// Docstring regina::python::doc::Packet::nextTreePacket
static constexpr const char nextTreePacket[] =
...
// Docstring regina::python::doc::Packet::nextTreePacket_2
static constexpr const char nextTreePacket_2[] =
R"doc(Finds the next packet after this in a complete depth-first iteration
of the entire tree structure to which this packet belongs. Note that
this packet need not be the tree matriarch.
...
// Docstring regina::python::doc::Packet::nextTreePacket_3
static constexpr const char nextTreePacket_3[] =
...
// Docstring regina::python::doc::Packet::nextTreePacket_4
static constexpr const char nextTreePacket_4[] =
R"doc(Finds the next packet after this of the requested type in a complete
depth-first iteration of the entire tree structure. Note that this
packet need not be the tree matriarch. The order of tree searching is
described in firstTreePacket().
...
// Docstring regina::python::doc::Packet::parent
...
// Docstring regina::python::doc::Packet::prepend
static constexpr const char prepend[] =
...
// Docstring regina::python::doc::Packet::prevSibling
static constexpr const char prevSibling[] =
...
// Docstring regina::python::doc::Packet::removeAllTags
static constexpr const char removeAllTags[] =
...
// Docstring regina::python::doc::Packet::removeTag
static constexpr const char removeTag[] =
...
// Docstring regina::python::doc::Packet::reparent
static constexpr const char reparent[] =
R"doc(Cuts this packet away from its parent in the tree structure, and
...
// Docstring regina::python::doc::Packet::root
...
// Docstring regina::python::doc::Packet::samePacket
static constexpr const char samePacket[] =
...
// Docstring regina::python::doc::Packet::save
...
// Docstring regina::python::doc::Packet::sortChildren
static constexpr const char sortChildren[] =
...
// Docstring regina::python::doc::Packet::swapWithNextSibling
static constexpr const char swapWithNextSibling[] =
...
// Docstring regina::python::doc::Packet::tags
...
// Docstring regina::python::doc::Packet::totalTreeSize
static constexpr const char totalTreeSize[] =
...
// Docstring regina::python::doc::Packet::transferChildren
static constexpr const char transferChildren[] =
...
// Docstring regina::python::doc::Packet::type
...
// Docstring regina::python::doc::Packet::typeName
...
// Docstring regina::python::doc::Packet::unlisten
static constexpr const char unlisten[] =
...
// Docstring regina::python::doc::Packet::writeXMLFile
static constexpr const char writeXMLFile[] =
...
// Docstring regina::python::doc::PacketChildren::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::PacketChildren::__eq
static constexpr const char __eq[] =
...
// Docstring regina::python::doc::PacketChildren::__iter__
static constexpr const char __iter__[] =
...
// Docstring regina::python::doc::PacketData::__copy
...
// Docstring regina::python::doc::PacketData::__default
static constexpr const char __default[] = R"doc(Default constructor that sets *heldBy_* to PacketHeldBy::None.)doc";

// Docstring regina::python::doc::PacketData::anonID
static constexpr const char anonID[] =
...
// Docstring regina::python::doc::PacketData::packet
static constexpr const char packet[] =
...
// Docstring regina::python::doc::PacketData::packet_2
static constexpr const char packet_2[] =
R"doc(Returns the packet that holds this data, if there is one.
...
// Docstring regina::python::doc::PacketDescendants::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::PacketDescendants::__eq
static constexpr const char __eq[] =
R"doc(Determines whether this and the given object are designed to iterate
...
// Docstring regina::python::doc::PacketDescendants::__iter__
static constexpr const char __iter__[] =
...
// Docstring regina::python::doc::PacketListener::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::PacketListener::childToBeAdded
static constexpr const char childToBeAdded[] =
...
// Docstring regina::python::doc::PacketListener::childToBeRemoved
static constexpr const char childToBeRemoved[] =
...
// Docstring regina::python::doc::PacketListener::childToBeRenamed
static constexpr const char childToBeRenamed[] =
...
// Docstring regina::python::doc::PacketListener::childWasAdded
static constexpr const char childWasAdded[] =
...
// Docstring regina::python::doc::PacketListener::childWasRemoved
static constexpr const char childWasRemoved[] =
...
// Docstring regina::python::doc::PacketListener::childWasRenamed
static constexpr const char childWasRenamed[] =
...
// Docstring regina::python::doc::PacketListener::childrenToBeReordered
static constexpr const char childrenToBeReordered[] =
...
// Docstring regina::python::doc::PacketListener::childrenWereReordered
static constexpr const char childrenWereReordered[] =
...
// Docstring regina::python::doc::PacketListener::isListening
static constexpr const char isListening[] =
...
// Docstring regina::python::doc::PacketListener::packetBeingDestroyed
static constexpr const char packetBeingDestroyed[] =
...
// Docstring regina::python::doc::PacketListener::packetToBeChanged
static constexpr const char packetToBeChanged[] =
...
// Docstring regina::python::doc::PacketListener::packetToBeRenamed
static constexpr const char packetToBeRenamed[] =
...
// Docstring regina::python::doc::PacketListener::packetWasChanged
static constexpr const char packetWasChanged[] =
...
// Docstring regina::python::doc::PacketListener::packetWasRenamed
static constexpr const char packetWasRenamed[] =
...
// Docstring regina::python::doc::PacketListener::unlisten
static constexpr const char unlisten[] =
...
// Docstring regina::python::doc::PacketOf::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::PacketOf::__copy
static constexpr const char __copy[] =
...
// Docstring regina::python::doc::PacketOf::__default
...
// Docstring regina::python::doc::PacketOf::__init
...
// Docstring regina::python::doc::PacketShell::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::PacketShell::__copy
static constexpr const char __copy[] =
...
// Docstring regina::python::doc::PacketShell::__eq
static constexpr const char __eq[] =
...
// Docstring regina::python::doc::PacketShell::__eq_2
...
// Docstring regina::python::doc::PacketShell::__init
static constexpr const char __init[] =
...
// Docstring regina::python::doc::PacketShell::hasTag
static constexpr const char hasTag[] =
R"doc(Determines whether this packet has the given associated tag.
...
// Docstring regina::python::doc::PacketShell::hasTags
static constexpr const char hasTags[] =
R"doc(Determines whether this packet has any associated tags at all.
...
// Docstring regina::python::doc::PacketShell::humanLabel
static constexpr const char humanLabel[] =
R"doc(Returns the label associated with this individual packet, adjusted if
necessary for human-readable output.
...
// Docstring regina::python::doc::PacketShell::internalID
static constexpr const char internalID[] =
R"doc(Returns a unique string ID that identifies this packet.
...
// Docstring regina::python::doc::PacketShell::label
static constexpr const char label[] =
...
// Docstring regina::python::doc::PacketShell::tags
static constexpr const char tags[] =
R"doc(Returns the set of all tags associated with this packet.
...
// Docstring regina::python::doc::SubtreeIterator::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::SubtreeIterator::__eq
static constexpr const char __eq[] =
R"doc(Tests whether this and the given iterator are equal.
...
// Docstring regina::python::doc::SubtreeIterator::__iter__
static constexpr const char __iter__[] =
...
// Docstring regina::python::doc::SubtreeIterator::__next__
static constexpr const char __next__[] =
