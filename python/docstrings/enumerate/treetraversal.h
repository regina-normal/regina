...
struct TautEnumeration {

// Docstring regina::python::doc::TautEnumeration::__class
...
be zero. See the LPConstraint concept and BanConstraintBase class
...
// Docstring regina::python::doc::TautEnumeration::__init
...
// Docstring regina::python::doc::TautEnumeration::next
...
// Docstring regina::python::doc::TautEnumeration::run
...
// Docstring regina::python::doc::TautEnumeration::solutions
static constexpr const char solutions[] =
...
// Docstring regina::python::doc::TautEnumeration::writeStructure
static constexpr const char writeStructure[] =
...
// Docstring regina::python::doc::TautEnumeration::writeTypes
static constexpr const char writeTypes[] =
...
struct TreeEnumeration {

// Docstring regina::python::doc::TreeEnumeration::__class
static constexpr const char __class[] =
R"doc(The main entry point for the tree traversal algorithm to enumerate all
...
LPConstraint concept and BanConstraintBase class documentation for
details.
...
// Docstring regina::python::doc::TreeEnumeration::__init
static constexpr const char __init[] =
R"doc(Creates a new object for running the tree traversal algorithm.
...
// Docstring regina::python::doc::TreeEnumeration::next
static constexpr const char next[] =
...
// Docstring regina::python::doc::TreeEnumeration::run
static constexpr const char run[] =
...
// Docstring regina::python::doc::TreeEnumeration::solutions
static constexpr const char solutions[] =
...
// Docstring regina::python::doc::TreeEnumeration::writeSurface
static constexpr const char writeSurface[] =
...
// Docstring regina::python::doc::TreeEnumeration::writeTypes
static constexpr const char writeTypes[] =
R"doc(A callback function that writes to standard output the type vector at
the current point in the given tree traversal search. You can use this
as the callback *action* that is passed to run().
...
struct TreeSingleSoln {

// Docstring regina::python::doc::TreeSingleSoln::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::TreeSingleSoln::__init
static constexpr const char __init[] =
...
// Docstring regina::python::doc::TreeSingleSoln::cancel
...
// Docstring regina::python::doc::TreeSingleSoln::find
...
// Docstring regina::python::doc::TreeTraversal::__class
static constexpr const char __class[] =
...
// Docstring regina::python::doc::TreeTraversal::buildSurface
static constexpr const char buildSurface[] =
...
// Docstring regina::python::doc::TreeTraversal::typeString
...
// Docstring regina::python::doc::TreeTraversal::visited
static constexpr const char visited[] =
