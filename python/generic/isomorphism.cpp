...
void addIsomorphism() {
    ...
    addIsomorphism<9>("Isomorphism9");
    addIsomorphism<10>("Isomorphism10");
    addIsomorphism<11>("Isomorphism11");
    addIsomorphism<12>("Isomorphism12");
    addIsomorphism<13>("Isomorphism13");
    addIsomorphism<14>("Isomorphism14");
