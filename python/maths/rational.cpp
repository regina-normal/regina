...
void addRational(pybind11::module_& m) {
    ...
    auto c = pybind11::class_<Rational>(m, "Rational", rdoc_scope)
        ...
        .def(pybind11::init<const Rational&>(), rdoc::__init_2)
        .def(pybind11::init<const Integer&>(), rdoc::__init_3)
        .def(pybind11::init<const LargeInteger&>(), rdoc::__init_3)
        .def(pybind11::init<long>(), rdoc::__init_4)
        .def(pybind11::init<const Integer&, const Integer&>(), rdoc::__init_5)
        .def(pybind11::init<const LargeInteger&, const LargeInteger&>(),
            rdoc::__init_5)
        .def(pybind11::init<long, unsigned long>(), rdoc::__init_6)
    ...
    regina::python::add_global_swap<Rational>(m, rdoc_global::swap);
