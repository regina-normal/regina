...
void addPerm4(pybind11::module_& m) {
    ...
    auto c = pybind11::class_<Perm<4>>(m, "Perm4", rdoc_scope)
        ...
        .def(pybind11::init<int, int, int, int>(), rdoc::Perm_3)
        .def(pybind11::init<const std::array<int, 4>&>(), rdoc::Perm_4)
        .def(pybind11::init<int, int, int, int,
                            int, int, int, int>(), rdoc::Perm_5)
        .def(pybind11::init<const Perm<4>&>(), rdoc::Perm_6)
