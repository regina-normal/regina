...
void addDim4Tetrahedron() {
    class_<FaceEmbedding<4, 3>>("FaceEmbedding4_3",
        ...
        .def("toString", &Dim4TetrahedronEmbedding::str)
        .def("detail", &Dim4TetrahedronEmbedding::detail)
        .def("toStringLong", &Dim4TetrahedronEmbedding::detail)
    ...
    class_<Face<4, 3>, std::auto_ptr<Face<4, 3>>,
        ...
        .def("toString", &Dim4Tetrahedron::str)
        .def("detail", &Dim4Tetrahedron::detail)
        .def("toStringLong", &Dim4Tetrahedron::detail)
