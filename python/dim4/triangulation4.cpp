...
void addTriangulation4(pybind11::module_& m, pybind11::module_& internal) {
    ...
    auto c = pybind11::class_<Triangulation<4>,
        ...
        .def("countFaces", (regina::python::countFacesFunc<4>)(
        ...
        .def("faces", (regina::python::facesFunc<4>)(&Triangulation<4>::faces),
        ...
        .def("face", (regina::python::faceFunc<4>)(&Triangulation<4>::face),
