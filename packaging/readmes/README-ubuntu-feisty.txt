Regina for Ubuntu:  Feisty (Ubuntu 7.04)
----------------------------------------

Ubuntu packages for Regina are not distributed from the SourceForge site.

Instead, users of Feisty Fawn (the Ubuntu 7.04 release) may obtain
...
1. Add Regina's location to your list of repositories.
   ...
   Synaptic will ask you for an APT line, which is:
     ...
     deb http://people.debian.org/~bab/regina/ feisty main
...
You might have noticed that Feisty Fawn already offers Regina as part of
its universe section.  However, this is the older version 4.3.1 (which
was current when Feisty Fawn was released).  For a newer version of
