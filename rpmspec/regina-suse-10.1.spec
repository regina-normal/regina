...
%changelog
* Sun Oct 28 2007 Ben Burton <bab@debian.org> 4.4
- New upstream release.

* Thu Nov 2 2006 Ben Burton <bab@debian.org> 4.3.1
- Packaging the 4.3.1 release (May 2006) for SuSE 10.1.
- Reenabled Python scripting, since the boost packages that were broken
  in earlier versions of SuSE are now fixed.
